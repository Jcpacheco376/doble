...
struct SM64LimbTransform {
    float position[3];  // Coordenadas X, Y, Z
    float rotation[4];  // Cuaternión (X, Y, Z, W)
};
...
enum SM64LimbID {
    ...
    SM64_LIMB_R_SHIN,
    SM64_LIMB_R_FOOT,
    SM64_LIMB_L_UPPER_ARM,
    SM64_LIMB_L_FOREARM,
    SM64_LIMB_L_HAND,
    SM64_LIMB_R_UPPER_ARM,
    SM64_LIMB_R_FOREARM,
    SM64_LIMB_R_HAND,
    SM64_LIMB_TORSO,
    SM64_LIMB_HEAD,
...
extern SM64_LIB_FN void sm64_get_limb_transform( int32_t marioId, int32_t limbId, struct SM64LimbTransform *outTransform );
